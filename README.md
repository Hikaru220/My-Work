...
Код и материалы этого репозитория открыты для просмотра в портфолио-целях, но
защищены авторским правом — см. [LICENSE](LICENSE). Использование, копирование
или распространение без письменного разрешения автора не допускается.
