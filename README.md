...
Пять систем в проде и в активной разработке — от EdTech-платформы с реальными платежами до собственной сети Minecraft с кросс-серверной синхронизацией. Ниже — не лендинги, а рабочий код с настоящими пользователями, деньгами и деплоями.

`5 проектов` · `≈59 000 строк кода` · `5 языков: JS/TS, Python, Kotlin, Java, SQL` · `19 плагинов в одной только игровой сети`
...
| | |
|---|---|
| **Backend** | Node.js / Express, NestJS + TypeORM, FastAPI + SQLAlchemy (async), aiogram 3 |
| **Мобайл** | React Native / Expo + TypeScript, нативный Kotlin + Jetpack Compose |
| **Данные** | PostgreSQL, MySQL, SQLite — от локальной офлайн-first базы до релей-таблиц между серверами |
| **Игры / JVM** | Java 21, Paper API, Maven / Gradle |
| **Интеграции** | OAuth2, Telegram Bot API, платёжные вебхуки, Gemini AI, JDA (Discord), LuckPerms/PlaceholderAPI |
...
<img src="images/kasso-screenshot.png" width="240" alt="Экран входа в админ-панель Kasso">
