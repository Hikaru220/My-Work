...
export const COLLECTIONS: Collection[] = [
  {
    ...
    priceFrom: 42900,
    tagline: "тишина классических линий",
    blurb: "Эмаль слоновая кость на плотном основании — ровная, без бликов, для любого проёма.",
  },
  {
    id: "walnut",
    title: "Орех Гранд",
    ...
    badge: "Хит",
    priceFrom: 51300,
    tagline: "тепло натурального шпона",
    blurb: "Шпон ореха с выраженной текстурой — рисунок волокон не повторяется дважды.",
  },
  {
    id: "loft",
    title: "Лофт Сталь",
    ...
    badge: "Новинка",
    priceFrom: 68400,
    tagline: "индустриальная строгость",
    blurb: "Металлокаркас и сатинированное стекло — для интерьеров с характером.",
  },
  {
    id: "minimal",
    title: "Минимал",
    ...
    priceFrom: 47800,
    tagline: "ничего лишнего",
    blurb: "Скрытая коробка и светлый дуб — дверь растворяется в стене, остаётся только свет.",
  },
  {
    id: "wenge",
    title: "Венге Люкс",
    ...
    badge: "Премиум",
    priceFrom: 73600,
    tagline: "плотность благородного дерева",
    blurb: "Глубокий цвет венге, который не выгорает и не боится ежедневной эксплуатации.",
  },
  {
    id: "reeded",
    title: "Рейка",
    ...
    badge: "Дизайн",
    priceFrom: 81200,
    tagline: "ритм вертикальных линий",
    blurb: "Рифлёный дуб на поворотной оси — акцентная дверь, которая держит взгляд.",
  },
];
