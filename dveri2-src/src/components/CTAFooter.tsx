...
export function CTAFooter() {
  return (
    <footer id="contact" className="bg-canvas-dusk text-ink">
      <div className="mx-auto max-w-7xl px-5 pb-16 pt-24 sm:px-8 sm:pt-28 lg:px-10 lg:pt-36">
        ...
        >
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 border border-ink/25 px-7 py-4 text-ink transition-colors duration-300 hover:border-ink/60"
            >
              <Phone size={15} />
        ...
        <div className="hairline-top mt-24 grid grid-cols-1 gap-10 border-ink/10 pt-12 sm:grid-cols-2 lg:mt-28 lg:grid-cols-4">
          <div>
            <span className="font-display text-2xl font-semibold">{BRAND.name}</span>
            <p className="mt-3 max-w-[24ch] text-base leading-relaxed text-ink-soft">{BRAND.tagline}</p>
          </div>

          <div className="flex flex-col gap-3 text-base text-ink-soft">
            <span className="label mb-1 text-ink-faint">Навигация</span>
          ...
          <div className="flex flex-col gap-3 text-base text-ink-soft">
            <span className="label mb-1 text-ink-faint">Контакты</span>
          ...
          <div className="flex flex-col gap-3 text-base text-ink-soft">
            <span className="label mb-1 text-ink-faint">Готовы начать</span>
            <a
              href={CONTACT.whatsappHref}
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="mt-16 flex flex-col gap-2 text-sm text-ink-faint sm:flex-row sm:items-center sm:justify-between">
          <span>© {new Date().getFullYear()} {BRAND.name}. Все права защищены.</span>
          <span>Демонстрационный сайт · вариант оформления 2</span>
        </div>
      </div>
    </footer>
  );
